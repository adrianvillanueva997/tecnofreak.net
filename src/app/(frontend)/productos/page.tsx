    ...
    <div className="mx-auto max-w-4xl px-4 pt-10 sm:px-6 pb-16">
      <header className="border-b-2 border-teal pb-5">
        ...
        <p className="mt-3 max-w-prose text-sm leading-relaxed text-fog">
          Gadgets, componentes y herramientas que merecen la pena, con enlace directo a Amazon.
          Los precios se revisan periódicamente y pueden variar.
        </p>
      </header>
...
export function generateMetadata(): Metadata {
  return {
    ...
    description: 'Gadgets y herramientas recomendadas en tecnofreak.net, con enlaces de afiliado.',
  }
}
